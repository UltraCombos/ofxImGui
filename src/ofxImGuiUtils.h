...
#ifndef INCLUDE_OF_ADDONS_OFXIMGUIUTILS_H_
#define INCLUDE_OF_ADDONS_OFXIMGUIUTILS_H_
...
namespace ofxImGui
{
	...
	namespace utils
	{
		...
		typedef void(*draw_param_func)(ofAbstractParameter*, void*);

		using DrawParamFunc = std::function<void(ofAbstractParameter*, void*)>;
		using DrawParamFunc1 = std::function<void(ofAbstractParameter*)>;

		void draw_bool(ofParameter< bool >* p_param, void*)
		{
		...
		void draw_float_slider_default(ofParameter< float >* p_param, char const* fmt)
		{
		...
		void draw_int_slider_default(ofParameter< int >* p_param, void*)
		{
		...
		void draw_float_drag_default(ofParameter< float >* p_param, char const* fmt)
		{
			float f_value = p_param->get();
		...
		void draw_int_drag_default(ofParameter< int >* p_param, void*)
		{
			int i_value = p_param->get();
			float delta = p_param->getMax() - p_param->getMin();
		...
		void draw_float_input_default(ofParameter< float >* p_param, char const* fmt)
		{
			float f_value = p_param->get();
			float delta = p_param->getMax() - p_param->getMin();
		...
		void draw_int_input_default(ofParameter< int >* p_param, void*)
		{
			int i_value = p_param->get();
		...
		void draw_text_input(ofParameter < std::string >* p_param, void*)
		{
		...
		void draw_rect(ofParameter< ofRectangle >*p_param, char const* fmt)
		{
		...
		void draw_texture(ofTexture& tex, bool is_show_detail = true, bool is_origin = false )
		{
			if (!tex.isAllocated())
			{
				return;
...
#endif//INCLUDE_OF_ADDONS_OFXIMGUIUTILS_H_
